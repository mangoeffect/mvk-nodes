...
TEST_CASE("test mvk-filter box-filter", "[mvk-filter]")
{
    ...
    REQUIRE(rgb_5x5_filter.Save("rgb_5x5_filter.png") == 0);
    
    Image rgb_15x15_filter;
    REQUIRE(BoxFilter(rgb_img, rgb_15x15_filter, 15) == 0);
    REQUIRE(rgb_15x15_filter.Save("rgb_15x15_filter.png") == 0);
    ...
    REQUIRE(mono_7x7_filter.Save("mono_7x7_filter.png") == 0);
}
